...
CAR_DATA = [
    ("GR86 / BRZ", "gr86-brz", "入门后驱", "轻量化改装热度 98", "/static/assets/exhaust.png"),
    ("A90 Supra", "a90-supra", "性能旗舰", "动力升级热度 96", "/static/assets/supra-garage.png"),
    ("WRX STI", "wrx-sti", "四驱平台", "拉力风格热度 91", "/static/assets/wrx-garage.png"),
    ("R32 GT-R", "r32-gtr", "经典项目车", "JDM 经典热度 99", "/static/assets/engine-rb26.png"),
    ("BMW M2", "bmw-m2", "M 系入门性能", "短轴后驱热度 95", "/static/assets/car-bmw-m.jpg"),
    ("BMW M3", "bmw-m3", "M 系标杆", "四门性能热度 98", "/static/assets/car-bmw-m.jpg"),
    ("BMW M4", "bmw-m4", "M 系轿跑", "双门赛道热度 97", "/static/assets/car-bmw-m.jpg"),
    ("BMW M5", "bmw-m5", "M 系旗舰", "高性能行政热度 92", "/static/assets/car-bmw-m.jpg"),
    ("Mercedes-AMG A 45", "mercedes-amg-a45", "AMG 钢炮", "钢炮改装热度 94", "/static/assets/car-amg.jpg"),
    ("Mercedes-AMG C 63", "mercedes-amg-c63", "AMG 中坚", "C 级性能热度 93", "/static/assets/car-amg.jpg"),
    ("Mercedes-AMG GT", "mercedes-amg-gt", "AMG 跑车", "GT 跑车热度 96", "/static/assets/car-amg.jpg"),
    ("Audi S3", "audi-s3", "S 系入门", "四驱钢炮热度 93", "/static/assets/car-audi-rs.jpg"),
    ("Audi S4", "audi-s4", "S 系性能", "旅行/轿车热度 90", "/static/assets/car-audi-rs.jpg"),
    ("Audi RS 3", "audi-rs3", "RS 钢炮", "五缸钢炮热度 98", "/static/assets/car-audi-rs.jpg"),
    ("Audi RS 5", "audi-rs5", "RS 轿跑", "双门四驱热度 94", "/static/assets/car-audi-rs.jpg"),
    ("Audi RS 6 Avant", "audi-rs6-avant", "RS 旅行车", "性能旅行热度 99", "/static/assets/car-audi-rs.jpg"),
    ("Audi RS e-tron GT", "audi-rs-e-tron-gt", "RS 纯电", "纯电性能热度 91", "/static/assets/car-audi-rs.jpg"),
]
