...
SESSION_COOKIE_SECURE = os.environ.get('TUNERHUB_SESSION_COOKIE_SECURE', '1' if not DEBUG else '0') == '1'
CSRF_COOKIE_SECURE = os.environ.get('TUNERHUB_CSRF_COOKIE_SECURE', '1' if not DEBUG else '0') == '1'
